...
// The Solid 1-era UIbench shape, kept as a secondary target for the record
// (the idiomatic 2.0 authoring is ../solid: a signal of the raw snapshot and
// keyed <For>): one keyed `reconcile` of the whole snapshot into a store each
